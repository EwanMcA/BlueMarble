...
namespace BlueMarble {
    ...
    OpenGLTexture2D::OpenGLTexture2D(const std::string & path)
    {
        ...
        // TODO: Stop forcing 4 channels here, instead check channels before glTexImage2D(...)
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, oWidth, oHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
